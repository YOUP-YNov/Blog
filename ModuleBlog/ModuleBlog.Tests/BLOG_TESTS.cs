...
namespace ModuleBlog.Tests
{
    ...
    public class BLOG_TESTS
    {
        ...
        {
            //A voir avec Maxime au niveau de la procédure stockée

            Assert.IsTrue(blogDAL.AddBlog(new BlogDao { Utilisateur_id = 8, TitreBlog = "Blog de l'utilisateur Test", Categorie_id = 3, Promotion = false, Actif = true, Theme_id = 4, DateCreation = DateTime.Now }) == "OK", "Blog existe déjà");
        }
